...
{
    [DbContext(typeof(NBCartDbContext))]
    [Migration("20220525070714_UpdateLineItemEntityCode")]
    partial class UpdateLineItemEntityCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.CartModule.Data.Model.LineItemEntity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("LineItemEntity");
                });
            ...
            modelBuilder.Entity("NB.CartModule.Data.Models.NBCartLineItemEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.CartModule.Data.Model.LineItemEntity");

                    b.Property<string>("PrescriptionId")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);

                    b.HasDiscriminator().HasValue("NBCartLineItemEntity");
                });
